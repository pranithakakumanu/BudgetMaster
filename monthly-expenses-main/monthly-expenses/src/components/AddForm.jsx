...
const AddForm = ({ setGetID, getID, setExpense, expense, formData, setFormData }) => {
    ...
    const handleResetExpenses = () => {
        setExpense([]); // Reset expenses list
    };
        ...
        mt-7 mx-auto p-2'>
            <form onSubmit={submitHandler} className="w-[100%] p-5">
                ...
                <div className="flex justify-between">
                    ...
                    <button onClick={handleResetExpenses} className="mt-4 p-2 bg-red-300 rounded-lg font-bold text-red-800">Reset Expenses</button>
                </div>
            </form>       
        </div>
    );
